...
/**
 * Template Name: 2017 Kaukauna Camp Receipt
 * Version: 1.0
...
<div class="document">
	...
	<div class="inner">
		<div class="left">
			<h2>2017 Kaukauna Camp Receipt</h2>
			...
			<p>{Which sessions will you be attending? (Women\'s College Session on Friday June 23rd - Saturday June 24th):30.1}</p>
            <p>{Which sessions will you be attending? (Men\'s College Session on Saturday June 24th - Sunday June 25th):30.2}</p>
            <p>{Which sessions will you be attending? (High School Master and L5 Session on Friday June 23rd):30.3}</p>
            <p>{Which sessions will you be attending? (High School - Master, L5, and L4 Session on Saturday Morning, June 24th):30.4}</p>
            <p>{Which sessions will you be attending? (High School - All Levels Session (2 and 3 person) on Saturday Afternoon, June 24th):30.5}</p>
            <p>{Which sessions will you be attending? (High School - All Levels Session (2 and 3 person) on Sunday June 25th):30.6}</p>
		...
		<div class="right">
	        ...
	        <p>{Hotel accomadations are NOT included in your camp registration. However, if you need a room, we have a block reserved at the Quality Inn and Suites at a reduced rate. If interested in reducing cost even further, we can also help you find a camper to room with.:11}</p>
	    ...
	    <div class="notes">
	        ...
	        <ul>
	            ...
	            <li>Full refunds are accepted until May 23, 2017.</li>
	    ...
	    <div class="footer">
	        <h4>We look forward to having you at this year's Kaukauna Camp!</h4>
